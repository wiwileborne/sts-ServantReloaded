...
import servantreloaded.util.CardArtRoller;
...
public abstract class AbstractEasyCard extends CustomCard {
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target) {
        this(cardID, cost, type, rarity, target, ServantCharacter.Enums.SILVER);
    }
    ...
    public AbstractEasyCard(final String cardID, final int cost, final CardType type, final CardRarity rarity, final CardTarget target, final CardColor color) {
        ...
        cardStrings = LocalizationHelper.GetCard(makeID(this.cardID));
    ...
    public static String getCardTextureString(final String cardName, final AbstractCard.CardType cardType) {
        ...
        switch (cardType) {
            case ATTACK:
                textureString = makeCardPath(cardName,".png");
                break;
            case POWER:
                textureString = makeCardPath(cardName,".png");
                break;
