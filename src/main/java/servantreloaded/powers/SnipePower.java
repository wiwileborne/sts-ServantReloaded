 ...
 public class SnipePower extends AbstractEasyPower {
     public static String ID = makeID("SnipePower");
     ...
     public void atStartOfTurnPostDraw() {
         if (owner.hasPower(TrueSightPower.ID) || isValidTargetAndIntent(target,prediction)) {
             flash();
             atb(new ThrowKnivesAction(AbstractDungeon.player, target, new DamageInfo(this.owner, this.amount, DamageInfo.DamageType.NORMAL), "Vulnerable"));
         }
