 ...
 import servantreloaded.actions.StressRelieverAction;
 ...
 public class StressRelieverPower  extends AbstractEasyPower {
     public static final String ID = makeID("StressRelieverPower");
   ...
   public void atStartOfTurn() {
     flash();
     atb(new StressRelieverAction(this.amount));
   }
 }
