 ...
 public class UpgradedEmbodimentPower  extends AbstractEasyPower {
     public static final String ID = makeID("UpgradedEmbodimentPower");
     ...
     public UpgradedEmbodimentPower(AbstractCreature owner, int amount) {
