...
public class CardArtRoller {
    private static final Texture attackMask = TexLoader.getTexture(ServantReloadedMod.makeImagePath("masks/AttackMask.png"));
    private static final Texture skillMask = TexLoader.getTexture(ServantReloadedMod.makeImagePath("masks/SkillMask.png"));
    private static final Texture powerMask = TexLoader.getTexture(ServantReloadedMod.makeImagePath("masks/PowerMask.png"));
